...
-- guess-indent, gitsigns, diffview, which-key, colorscheme, todo-comments, mini modules
-- ============================================================
do
  ...
  -- Plenary is also used by Telescope below.
  ...
  vim.keymap.set('n', '<leader>gs', '<cmd>DiffviewOpen --cached<CR>', { desc = '[G]it [S]taged diff' })

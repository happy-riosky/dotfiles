...
let s:p.normal.left = [ [ s:mantle, s:yellow ], [ s:yellow, s:base ] ]
let s:p.normal.right = [ [ s:overlay0, s:base ], [ s:yellow, s:surface0 ] ]
let s:p.inactive.right = [ [ s:surface1, s:base ], [ s:overlay0, s:base ] ]
let s:p.inactive.left =  [ [ s:yellow, s:base ], [ s:overlay0, s:base ] ]
let s:p.insert.left = [ [ s:mantle, s:teal ], [ s:yellow, s:base ] ]
let s:p.replace.left = [ [ s:mantle, s:red ], [ s:yellow, s:base ] ]
let s:p.visual.left = [ [ s:mantle, s:mauve ], [ s:yellow, s:base ] ]
let s:p.normal.middle = [ [ s:yellow, s:surface1 ] ]
let s:p.inactive.middle = [ [ s:surface1, s:base ] ]
let s:p.tabline.left = [ [ s:overlay0, s:base ], [ s:overlay0, s:base ] ]
let s:p.tabline.tabsel = [ [ s:yellow, s:surface1 ], [ s:overlay0, s:base] ]

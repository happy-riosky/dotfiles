" Name: catppuccin_latte_yellow.vim
" Description: Catppuccin Latte with yellow (#DF8E1D) accent
...
let g:colors_name='catppuccin_latte_yellow'
set t_Co=256
...
call s:hi("WildMenu", "NONE", s:base, s:yellow, "NONE", "NONE")
